...
INSERT INTO turma values (1, "SI20142");

INSERT INTO curso values (1, "Sistemas de Informação", 1, 1);

INSERT INTO aluno VALUES
(1, "Hector Roberto Velásquez Aguilar", "hector", "hector", 1, 1),
(2, "Brunna Rayanne Gonçalves Costa", "bruna", "bruna", 1, 1);
...
(2, "Sr. Hector Roberto Velásquez", "admin", "admin", 1 ),
...
(1, "Gestão de Projetos", 1, 1, 1, 1),
(2, "Padrão de Projetos", 2, 1, 1, 1),
(3, "Legislação e Ética", 1, 1, 1, 1),
(4, "Programação OO Web", 3, 1, 1, 1),
(5, "Gestão da Informação", 4, 1, 1, 1);
